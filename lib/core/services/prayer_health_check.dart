...
class PrayerHealthCheck {
  ...
  static Future<void> init() async {
    _healthBox = await Hive.openBox<dynamic>(HiveBoxes.healthCheck);
  ...
  static Future<CheckResult> _checkExactAlarmPermission() async {
    ...
    return CheckResult(
      ...
      issue: (status.isGranted || status.isLimited)
          ? null
          : const HealthIssue(
              code: 'ALARM_PERM',
    ...
    return CheckResult(
      ...
      issue: status.isGranted
          ...
          : const HealthIssue(
              ...
              description:
                  'استثنِ التطبيق من تحسين البطارية لضمان الأذان في الوقت',
              severity: IssueSeverity.warning,
