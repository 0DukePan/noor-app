...
class QuranAudioEngine {
  ...
  static const Map<String, ReciterInfo> reciters = {
    ...
    'ar.mahirmuaiqly': ReciterInfo(
      id: 'ar.mahirmuaiqly',
      arabicName: 'ماهر المعيقلي',
      englishName: 'Maher Al-Muaiqly',
      baseUrl: 'https://cdn.islamic.network/quran/audio/128/ar.mahirmuaiqly',
      flag: '🇸🇦',
    ),
    'ar.yasseraldawsary': ReciterInfo(
      id: 'ar.yasseraldawsary',
      arabicName: 'ياسر الدوسري',
      englishName: 'Yasser Al-Dossari',
      baseUrl: 'https://cdn.islamic.network/quran/audio/128/ar.yasseraldawsary',
      flag: '🇸🇦',
    ),
    'ar.hudhaify': ReciterInfo(
      id: 'ar.hudhaify',
      arabicName: 'علي الحذيفي',
      englishName: 'Ali Al-Hudhaify',
      baseUrl: 'https://cdn.islamic.network/quran/audio/128/ar.hudhaify',
      flag: '🇸🇦',
    ),
    'ar.abdullahbasfar': ReciterInfo(
      id: 'ar.abdullahbasfar',
      arabicName: 'عبد الله باسفر',
      englishName: 'Abdullah Basfar',
      baseUrl: 'https://cdn.islamic.network/quran/audio/128/ar.abdullahbasfar',
      flag: '🇸🇦',
    ),
    'ar.muhammadayyoub': ReciterInfo(
      ...
      baseUrl: 'https://cdn.islamic.network/quran/audio/128/ar.muhammadayyoub',
      flag: '🇸🇦',
    ),
    'ar.saadghamdi': ReciterInfo(
      id: 'ar.saadghamdi',
      arabicName: 'سعد الغامدي',
      englishName: 'Saad Al-Ghamdi',
      baseUrl: 'https://cdn.islamic.network/quran/audio/128/ar.saadghamdi',
      flag: '🇸🇦',
    ),
    'ar.saudalshuraym': ReciterInfo(
      id: 'ar.saudalshuraym',
      arabicName: 'سعود الشريم (المصحف المجود)',
      englishName: 'Saud Al-Shuraim (Mujawwad)',
      baseUrl: 'https://cdn.islamic.network/quran/audio/128/ar.saudalshuraym',
      flag: '🇸🇦',
    ),
    'ar.naseralqatami': ReciterInfo(
      id: 'ar.naseralqatami',
      arabicName: 'ناصر القطامي',
      englishName: 'Nasser Al-Qatami',
      baseUrl: 'https://cdn.islamic.network/quran/audio/128/ar.naseralqatami',
      flag: '🇸🇦',
    ),
    'ar.salahbukhatir': ReciterInfo(
      id: 'ar.salahbukhatir',
      arabicName: 'صلاح بو خاطر',
      englishName: 'Salah Bukhatir',
      baseUrl: 'https://cdn.islamic.network/quran/audio/128/ar.salahbukhatir',
      flag: '🇦🇪',
    ),
    'ar.abdulmuhsenalqasim': ReciterInfo(
